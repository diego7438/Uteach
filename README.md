...
Welcome to **Uteach** — a next-level collection of interactive Computer Vision projects built with Python, OpenCV, and MediaPipe. This repo is your playground for real-time vision, gesture games, AR filters, and more. If you want to learn, teach, or just flex your CV skills, you’re in the right place. 
...
## 📦 Projects
All demos are in the `demos/` folder. Try them all!

- **Fruit Ninja**: Slice flying fruit with your finger using hand tracking.
- **Rock Paper Scissors**: Play against the computer with real-time gesture recognition.
- **AR Sunglasses**: Put virtual sunglasses on your face using face detection and overlays.
- **Face Detection**: Classic face detection with OpenCV’s Haar cascades.
- **Face Overlay**: Put custom images (like your school’s head) on detected faces.
- **Hand Tracking**: See your hand landmarks in real time.
- **Gesture Detection**: Recognize and visualize hand gestures live.
- **Motion Detection**: Detect movement in your webcam feed.
- **Motion Game**: Play a game using motion detection as your controller.
...
## ▶️ Usage
Run any demo from the terminal:
```zsh
